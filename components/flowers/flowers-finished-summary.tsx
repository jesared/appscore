...
import type { FlowersRankingPlayer, FlowersRound } from "@/types/flowers-score";

type FlowersFinishedSummaryProps = {
  finishedAt?: string;
...
export function FlowersFinishedSummary({
  finishedAt,
  rankingPlayers,
  rounds,
  onReopenParty,
}: FlowersFinishedSummaryProps) {
      ...
      <CardHeader className="gap-4 border-b border-border/70">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            ...
            <CardDescription>
              Les scores sont verrouilles. Le resume reste visible et tu peux
              rouvrir la partie si une correction est necessaire.
            </CardDescription>
          </div>
