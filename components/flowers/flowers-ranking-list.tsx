...
import type { FlowersRankingPlayer } from "@/types/flowers-score";
...
type FlowersRankingListProps = {
  rankingPlayers: FlowersRankingPlayer[];
};

export function FlowersRankingList({ rankingPlayers }: FlowersRankingListProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Classement final</CardTitle>
        <CardDescription>
          Le classement se base sur le total cumule de toutes les manches.
        </CardDescription>
      </CardHeader>
